...
${txtbld}OPTIONS${txtrst}:
	...
	-J	When -j is TRUE,  supply a value to add to all values in data
		...
		used to substitute -Inf generated by log(0). [${bldred}Default 1${txtrst}]
...
while getopts "hf:t:u:v:x:y:M:L:K:r:w:l:a:A:b:k:c:d:n:g:s:j:J:m:o:G:C:O:q:e:i:p:Z:z:" OPTION
do
	case $OPTION in
		h)
			echo "Help mesage"
