...
using function ggplot and stat_binhex from package ggplot2 and heixbin. 
...
${txtbld}OPTIONS${txtrst}:
	...
	-v	The variable for vertical axis.${bldred}[NECESSARY]${txtrst}
		${bldred}[Default Yes, accepts False or lm which menas
		add linear regression line and 95% confidence region.]${txtrst}
